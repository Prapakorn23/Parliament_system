...
class ParliamentWordCategorizer:
    ...
    def __init__(self):
        ...
        self.categories = {
            ...
            'การเงิน/งบประมาณ': [
                'งบประมาณ','การเงิน','งบ','แผนงบประมาณ','การจัดสรรงบ',
                'งบดำเนินงาน','งบลงทุน','งบผูกพัน','การใช้จ่าย','เบิกจ่าย',
                'การเบิก','ค่าใช้จ่าย','ค่าใช้สอย','ค่าเดินทาง','ค่าตอบแทน',
                'รายรับ','รายจ่าย','เงินรายได้','เงินอุดหนุน','เงินทุน','เงินสะสม',
                'จัดซื้อจัดจ้าง','พัสดุ','จัดซื้อ','จัดจ้าง','TOR','ราคากลาง','e-GP','สัญญา',
                'การตรวจสอบ','ตรวจสอบงบ','การทำบัญชี','บัญชี','งบการเงิน','งบดุล',
                'กระแสเงินสด','งบกำไรขาดทุน','สินทรัพย์','หนี้สิน','ทุน','สำรอง'
            ],
            
            'โครงการ/แผนงาน': [
                'โครงการ','โครงการใหม่','โครงการต่อเนื่อง','แผนงาน',
                'แผนปฏิบัติการ','แผนยุทธศาสตร์','แผนพัฒนา','Roadmap','Timeline',
                'Milestone','เป้าหมาย','ตัวชี้วัด','KPI','การติดตาม','ความคืบหน้า',
                'รายงานผล','ปิดโครงการ','แผนดำเนินงาน','แผนปฏิบัติงาน',
                'แผนจัดซื้อจัดจ้าง','แผนปฏิบัติการจัดซื้อ','แผนงบประมาณ',
                'ผลการดำเนินงาน','ผลสัมฤทธิ์','ความสำเร็จ','การประเมินผล',
                'การติดตามประเมินผล','การรายงาน','ไตรมาส','ครึ่งปี','รอบปี'
            ],
            
            'เทคโนโลยี/ระบบ/ข้อมูล': [
                'เทคโนโลยี','ระบบ','IT','ICT','ระบบสารสนเทศ','ฐานข้อมูล',
                'Data','Big Data','Dashboard','Analytics','AI','Machine Learning',
                'Software','Application','Platform','Website','Server','Network',
                'Cloud','Cybersecurity','Digital Transformation','ระบบกล้อง',
                'ระบบบัตร','ระบบทะเบียน','ระบบงาน','ระบบคอมพิวเตอร์',
                'ระบบเครือข่าย','ระบบฐานข้อมูล','ระบบสำรองข้อมูล','Backup',
                'API','Integration','Interface','UI','UX','Mobile App','Web App',
                'Database','SQL','NoSQL','ความมั่นคงปลอดภัย','Information Security'
            ],
            
            'นโยบาย/กฎระเบียบ/กฎหมาย': [
                'นโยบาย','ระเบียบ','ข้อบังคับ','ประกาศ','คำสั่ง','มติ',
                'แนวปฏิบัติ','Guideline','หลักเกณฑ์','ข้อกำหนด','กฎหมาย',
                'พระราชบัญญัติ','Compliance','ธรรมาภิบาล','จริยธรรม',
                'คู่มือ','มาตรฐาน','ข้อปฏิบัติ','ระเบียบสำนักนายกรัฐมนตรี',
                'ระเบียบกระทรวงการคลัง','ระเบียบสำนักงาน','กฎกระทรวง',
                'ข้อบังคับกระทรวง','แนวทางปฏิบัติ','ประมวลจริยธรรม'
            ],
            
            'สถานที่/โครงสร้างพื้นฐาน': [
                'อาคาร','สถานที่','ห้องประชุม','ห้องเรียน','โครงสร้างพื้นฐาน',
                'ถนน','ทางเดิน','ที่จอดรถ','ระบบไฟฟ้า','ระบบประปา',
                'ระบบสาธารณูปโภค','ความปลอดภัย','ก่อสร้าง','ปรับปรุง',
                'ซ่อมบำรุง','ห้องปฏิบัติการ','ห้องทดลอง','อาคารสำนักงาน',
                'ลานจอดรถ','ป้ายสัญลักษณ์','สิ่งอำนวยความสะดวก','ลิฟต์',
                'บันไดหนีไฟ','ทางออกฉุกเฉิน','ระบบดับเพลิง','ระบบกล้องวงจรปิด'
            ],
            
            'วิจัย/นวัตกรรม': [
                'วิจัย','งานวิจัย','โครงการวิจัย','R&D','Innovation','นวัตกรรม',
                'ทุนวิจัย','ตีพิมพ์','Publication','วารสาร','Conference',
                'สิทธิบัตร','อนุสิทธิบัตร','งานสร้างสรรค์','ถ่ายทอดเทคโนโลยี',
                'วิจัยและพัฒนา','การวิจัย','ผลงานวิจัย','บทความวิจัย',
                'บทความวิชาการ','ผลงานวิชาการ','นักวิจัย','ผู้วิจัย',
                'วิธีวิจัย','Methodology','กรอบแนวคิด','แนวคิดการวิจัย'
            ],
            
            'ความร่วมมือ/ภายนอก': [
                'ความร่วมมือ','MOU','MOA','ภาคี','Partner','Stakeholder',
                'หน่วยงานภายนอก','ภาครัฐ','เอกชน','ต่างประเทศ','เครือข่าย',
                'ความร่วมมือทางวิชาการ','ความร่วมมือวิจัย','บันทึกความเข้าใจ',
                'บันทึกข้อตกลง','ความร่วมมือระหว่างหน่วยงาน','พันธมิตร',
                'องค์กรภาคี','เครือข่ายความร่วมมือ','การประสานงาน'
            ],
            
            'ปัญหา/ความเสี่ยง/การแก้ไข': [
                'ปัญหา','อุปสรรค','ความเสี่ยง','Risk','Issue','เหตุขัดข้อง',
                'ข้อร้องเรียน','Bottleneck','Incident','แนวทางแก้ไข',
                'มาตรการ','แผนป้องกัน','การควบคุม','การบริหารความเสี่ยง',
                'การจัดการความเสี่ยง','การระบุความเสี่ยง','การประเมินความเสี่ยง',
                'การลดความเสี่ยง','การแก้ปัญหา','การป้องกัน','การตรวจสอบ',
                'การทบทวน','การปรับปรุง','การพัฒนา','ข้อเสนอแนะ','แผนฉุกเฉิน'
            ]
        }
